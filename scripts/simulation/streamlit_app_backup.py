...
# CSS - Style Figma (Marianne + Bleu France)
st.markdown("""
<style>
    /* Import Police Marianne */
    @import url('https://cdn.jsdelivr.net/npm/@gouvfr/dsfr@1.11/dist/dsfr.min.css');
    ...
    :root {
        ...
        --vert-positif: rgba(5,157,8,0.2);
        --vert-positif-text: #059d08;
        --rouge-negatif: rgba(255,47,47,0.2);
        --rouge-negatif-text: #ff2f2f;
    }

    /* Police Marianne partout */
    * {
    ...
    [data-testid="stMetricDelta"][class*="increase"] {
        background-color: var(--vert-positif) !important;
        color: var(--vert-positif-text) !important;
        border-radius: 100px;
    ...
    [data-testid="stMetricDelta"][class*="decrease"] {
        background-color: var(--rouge-negatif) !important;
        color: var(--rouge-negatif-text) !important;
        border-radius: 100px;
        padding: 0.25rem 0.5rem;
    }

    /* Sidebar (fond blanc + bleu France pour sélection) */
    ...
    .stButton > button:hover {
        background-color: var(--bleu-france-hover);
    }

    /* Selectbox et inputs - Fond blanc au lieu de gris */
    ...
    /* Cartes/Containers blancs pour graphiques */
    .element-container {
    ...
    /* Corriger les fonds noirs résiduels */
    .stMarkdown, .stText {
        color: black !important;
    }
